...
likwid-perfctr  -C 03 -g L3 -m ./newtonPC < entrada_completo.dat > saida_likwid_L3.txt
likwid-perfctr  -C 03 -g CACHE -m ./newtonPC < entrada_completo.dat > saida_likwid_L2CACHE.txt
likwid-perfctr  -C 03 -g FLOPS_DP -m ./newtonPC < entrada_completo.dat > saida_likwid_FLOPS_DP.txt
